...
contract OneTimeJobOffer is HederaTokenService {
    ...
    constructor(address _employer, address _employee, address _token, int64 _amount) {
    ...
    function deposit() external onlyEmployer inStatus(PaymentStatus.NotDeposited) returns (int) {
    ...
    function release() external onlyEmployer inStatus(PaymentStatus.Deposited) returns (int) {
    ...
    function refund() external onlyEmployer inStatus(PaymentStatus.Deposited) returns (int) {
